...
public class EditPostTab {
    ...
    public FormPanel getEditPostTab() {
        ...
        hPanel.add(new Label("От: "));
        hPanel.add(fromDate);
        hPanel.add(new Label("До: "));
        hPanel.add(toDate);
        vPanel.add(hPanel);
...
//                    status.setText(String.valueOf(Long.parseLong(dateFromHidden.getValue())));
//                    status.setText(String.valueOf(post.getServDate().getTime()));
                    if ((DateTimeFormat.getFormat("dd.MM.yyyy HH:mm").parse(post.getCreationDate()).getTime()
                            > Long.parseLong(dateFromHidden.getValue())) &&
                            (DateTimeFormat.getFormat("dd.MM.yyyy HH:mm").parse(post.getCreationDate()).getTime()
                                    < Long.parseLong(dateToHidden.getValue()))){
