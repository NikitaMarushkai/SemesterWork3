...
public class Post_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  ...
  private static native java.util.Date getServDate(ru.kpfu.itis.group408.marushkai.domain.Post instance) /*-{
    return instance.@ru.kpfu.itis.group408.marushkai.domain.Post::servDate;
  }-*/;
  
  private static native void setServDate(ru.kpfu.itis.group408.marushkai.domain.Post instance, java.util.Date value) 
  /*-{
    instance.@ru.kpfu.itis.group408.marushkai.domain.Post::servDate = value;
  }-*/;
  ...
  public static void deserialize(SerializationStreamReader streamReader, ru.kpfu.itis.group408.marushkai.domain.Post instance) throws SerializationException {
    ...
    setServDate(instance, (java.util.Date) streamReader.readObject());
  ...
  public static void serialize(SerializationStreamWriter streamWriter, ru.kpfu.itis.group408.marushkai.domain.Post instance) throws SerializationException {
    ...
    streamWriter.writeObject(getServDate(instance));
